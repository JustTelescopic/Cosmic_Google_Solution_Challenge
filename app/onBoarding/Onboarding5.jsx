...
export default function OnBoarding5() {
  return (
    <View style={styles.container}>
      <Image
        source={require("../../assets/onboarding-assets/future.png")} // Use your local image or an online source
        style={styles.image}
      />
      <View style={styles.textContainer}>
        <View style={styles.curve} />
        <Text style={styles.title}>Predict Future Disease Outbreaks</Text>
        <Text style={styles.subtitle}>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
          nonumy
        </Text>
        <DotIndicator activeIndex={4} totalDots={6} />
        <NextButton title={"Next"} destination={"/onBoarding/selectrole"} />
      </View>
    </View>
  );
}
