...
export default function Onboarding4() {
  return (
    <View style={styles.container}>
      <Image
        source={require('../../assets/onboarding-assets/community.png')} // Use your local image or an online source
        style={styles.image}
      />
      <View style={styles.textContainer}>
        <View style={styles.curve}/>
        <Text style={styles.title}>Community Support & Knowledge Sharing</Text>
        <Text style={styles.subtitle}>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
        </Text>
       <DotIndicator activeIndex={2} totalDots={4}/>
       <NextButton title="Next" onPress={() => { router.push('/onBoarding/Onboarding5')}} accessibilityLabel="Next" />
      </View>
    </View>
  );
}
