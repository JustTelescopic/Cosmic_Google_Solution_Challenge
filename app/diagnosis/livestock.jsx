...
const topLivestockData = [
  { type: 'Cattle', description: 'Lorem ipsum dolor sit amet.', image: require('../../assets/diagosis-page-assets/cattle.png') },
  { type: 'Goat', description: 'Lorem ipsum dolor sit amet.', image: require('../../assets/diagosis-page-assets/ship.png') },
];
const bottomLivestockData = [
  { type: 'Horse', description: 'Lorem ipsum dolor sit amet.', image: require('../../assets/diagosis-page-assets/horse.png'),},
  { type: 'Pig', description: 'Lorem ipsum dolor sit amet.', image: require('../../assets/diagosis-page-assets/pig.png') },
];

const extraFeatures = [
  { type : 'Vaccination', description : 'Regular immunization to prevent diseases.', image :require('../../assets/diagosis-page-assets/vaccination.png') },
  { type : 'Proper nutrition', description : 'Balanced diet for strong immunity.', image : require('../../assets/diagosis-page-assets/nutrition.png') },
  { type : 'Hygiene maintenance', description : 'Clean living conditions to reduce infections.', image : require('../../assets/diagosis-page-assets/hygiene.png') },
]
const LivestockTypeScreen = () => {
  return (
    ...
    <View style={styles.bottomCardContainer}>
      {bottomLivestockData.map((item, index) => (
        <TouchableOpacity key={index} style={{...styles.card,flexBasis : index==0 ?  "40%" : "60%"}}>  
          <ImageBackground source={item.image} style={styles.cardImage}
     ...
     <View style={styles.headerContainer}> 
      <Text style={styles.header}>How To Handle Livestock Efficiently?</Text>
      <View style={styles.underline} />
    </View>
    {/* <View style={styles.cardContainer}>
      {topLivestockData.map((item, index) => (
...
export default LivestockTypeScreen;
